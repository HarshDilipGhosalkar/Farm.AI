...
const timeline = () => {
    ...
    const startListening = (language) => {
        ...
        recognition.onresult = (event) => {
            ...
            fetch("https://codeshashtra-allstackers.onrender.com/aiChatBot", requestOptions)
    ...
    return (
        <>
            <div className='w-full h-full flex flex-col justify-center items-center px-[40px]'>
{result!=""?(<>
    <div className='flex mt-[60%] justify-center items-center w-[90%] p-[5px] border border-gray-600 h-[100%] rounded-md bg-slate-400 text-white'>{result}</div>
