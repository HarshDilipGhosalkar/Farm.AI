...
from functions.postToInsta import postPhotoToInsta
...
class Hashtags(Resource):
    def post(self):
        ...
        question = """
            What are some hashtags that would be good for this image? Latest trending hashtags are preferred.
...
class Post(Resource):
    def post(self):
        ...
        return postPhotoToInsta(photo=images[0], caption=caption)
